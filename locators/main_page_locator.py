...
class MainPageLocators:
    ...
    ORDER_BUTTON_UP = (By.XPATH, ".//div[contains(@class, 'Header_Nav')]//button[contains(@class, 'Button_Button')]")
    ORDER_BUTTON_DOWN = (By.XPATH, ".//div[contains(@class, 'Home_FinishButton')]//button[contains(@class, 'Button_Button')]")
