...
class OrderPageLocator:
    ...
    #Экран второй аренды
    TITLE_PAGE_RENT_INFO = (By.XPATH, ".//div[contains(@class,'Order_Header')]")
    FIELD_DATA = (By.XPATH, ".//input[contains(@class, 'Input_Input') and contains(@placeholder, '* Когда привезти самокат')]")
    FIELD_RENT_PERIOD = (By.XPATH, ".//div[@class = 'Dropdown-placeholder' and text() = '* Срок аренды']")
    DROPDOWN_ITEM_RENTAL_PERIOD = (By.XPATH, ".//div[@class = 'Dropdown-menu']//div[text() = 'пятеро суток']")
    CHECKBOX_BLACK_COLOR_SAMOKAT = (".//input[@id = 'black']")
    FIELD_FOR_DELIVERY = (By.XPATH, ".//div[contains(@class, 'Input_Input')]//input[@placeholder='Комментарий для курьера']")
    BUTTON_MAKE = (By.XPATH, ".//div[contains(@class, 'Order_Button')]//button[text() = 'Заказать']")