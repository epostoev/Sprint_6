...
class OrderPage(BasePage):
    ...
    def set_second_page_info(self, data):
        ...
        self.add_text_to_element(
            OrderPageLocator.FIELD_COMMENTS,
            data["comment"])
